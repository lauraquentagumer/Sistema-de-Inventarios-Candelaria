...
switch ($_GET["op"]) {
	case 'guardaryeditar':
		...
		if (empty($idarticulo)) {
			$rspta=$articulo->insertar($idcategoria,$precio,$nombre,$stock,$descripcion,$imagen);
			echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
		}else{
			$rspta=$articulo->editar($idarticulo,$idcategoria,$precio,$nombre,$stock,$descripcion,$imagen);
