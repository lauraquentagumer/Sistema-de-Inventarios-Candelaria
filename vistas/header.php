...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>SIS</b> C</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SIS</b> CANDELARIA</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Gumer Anthony Laura Quenta-Desarrollo de software
                  <small>Diciembre 2020 Año COVID</small>
                </p>
              </li>
              <!-- Menu Footer-->
