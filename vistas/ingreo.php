  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-8 col-md-8 col-xs-12">
     ...
     <div class="form-group col-lg-2 col-md-2 col-xs-6">
      ...
      <input class="form-control" type="text" name="num_comprobante" id="num_comprobante" value="00001" placeholder="COD-001">
    </div>
    <div class="form-group col-lg-2 col-md-2 col-xs-6">
      <label for="">Impuesto: </label>
      <input class="form-control" type="text" name="impuesto" id="impuesto" value ="18" placeholder="18">
    </div>
