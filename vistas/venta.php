  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-8 col-md-8 col-xs-12">
     ...
     <div class="form-group col-lg-2 col-md-2 col-xs-6">
      ...
      <input class="form-control" type="text" name="serie_comprobante" id="serie_comprobante" value="COD-001" maxlength="7" placeholder="COD-001">
    </div>
     
    <div class="form-group col-lg-2 col-md-2 col-xs-6">
      <label for="">Impuesto: </label>
      <input class="form-control" type="text" name="impuesto" value="18" placeholder="18%" id="impuesto">
    </div>
